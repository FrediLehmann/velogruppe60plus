...
export default function Organisers() {
	return (
		<Box as="section">
			...
			<Text fontSize="lg">
				Sie können sich jederzeit bei einem unserer Organisatoren melden, entweder per E-Mail oder
				telefonisch.
			</Text>
			<Grid mt="8" templateColumns={['1fr', 'repeat(2, 1fr)']} gap={['3', '4']} flexWrap="wrap">
				<GridItem>
					<OrganiserCard
						image={paul}
						name="Paul Lehmann"
