...
--
-- Name: touren; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
CREATE TABLE "public"."touren" (
    ...
    "descent" "text",
    "duration" "text",
    "next_tour" boolean DEFAULT false NOT NULL,
    "image" "text"
);


ALTER TABLE "public"."touren" OWNER TO "supabase_admin";

--
-- Name: Touren_id_seq; Type: SEQUENCE; Schema: public; Owner: supabase_admin
--

ALTER TABLE "public"."touren" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."Touren_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: touren Touren_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."touren"
    ADD CONSTRAINT "Touren_pkey" PRIMARY KEY ("id");


--
-- Name: touren Admin:Delete; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Admin:Delete" ON "public"."touren" FOR DELETE TO "authenticated" USING (true);


--
-- Name: touren Admin:Insert; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Admin:Insert" ON "public"."touren" FOR INSERT TO "authenticated" WITH CHECK (true);


--
-- Name: touren Admin:Update; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Admin:Update" ON "public"."touren" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);


--
-- Name: touren All:Select; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "All:Select" ON "public"."touren" FOR SELECT TO "anon", "authenticated" USING (true);


--
-- Name: touren; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--
...
-- TODO: See why the scema doesn't exist
...
--
-- Name: TABLE "touren"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE "public"."touren" TO "postgres";
GRANT ALL ON TABLE "public"."touren" TO "anon";
GRANT ALL ON TABLE "public"."touren" TO "authenticated";
GRANT ALL ON TABLE "public"."touren" TO "service_role";


--
-- Name: SEQUENCE "Touren_id_seq"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON SEQUENCE "public"."Touren_id_seq" TO "postgres";
GRANT ALL ON SEQUENCE "public"."Touren_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."Touren_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."Touren_id_seq" TO "service_role";
